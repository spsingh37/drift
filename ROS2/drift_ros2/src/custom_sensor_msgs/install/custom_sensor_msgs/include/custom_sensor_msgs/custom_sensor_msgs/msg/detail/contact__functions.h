...
#ifndef CUSTOM_SENSOR_MSGS__MSG__DETAIL__CONTACT__FUNCTIONS_H_
#define CUSTOM_SENSOR_MSGS__MSG__DETAIL__CONTACT__FUNCTIONS_H_
 ...
 * calls
 * custom_sensor_msgs__msg__Contact__init().
...
/**
 * It calls
 * custom_sensor_msgs__msg__Contact__fini()
 ...
 * custom_sensor_msgs__msg__Contact__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * custom_sensor_msgs__msg__Contact__Sequence__fini()
 * on the array,
...
#endif  // CUSTOM_SENSOR_MSGS__MSG__DETAIL__CONTACT__FUNCTIONS_H_
